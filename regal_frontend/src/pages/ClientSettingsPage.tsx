...
import './FactFinder.css'; // Reusing styles from the Fact Finder
import { useAuth } from '../auth/AuthContext';

// --- Create a specific type for the data we send to the API ---
...
const ClientSettingsPage: React.FC = () => {
    ...
    // This state will now correctly update whenever the user object changes
    ...
    // --- THIS IS THE FIX ---
    // This useEffect hook will run whenever the global 'user' object changes (e.g., after a new login).
